...
export default class InputWidget {
  ...
  runscript() {
    ...
    var andre_oppg =
      oppgaver_navn.length >= 2 ? oppgaver_navn[1] : oppgaver_navn[0] //tar høyde for om bare en oppg i array
    ...
    if (task_paraval != null && task_paraval != "") {
      ...
      svg_navn =
        oppgaver_navn[posi] != null ? oppgaver_navn[posi] : oppgaver_navn[0]
      neste_svg =
        oppgaver_navn[posi + 1] != null ? oppgaver_navn[posi + 1] : andre_oppg
    } else {
    ...
    ajax.onload = e => {
      ...
      $(".click_tallbrikker").click(function() {
        ...
        $(".click").click(function() {
          ...
          cc[cc.length] = {
            x: this.x.baseVal[0].value,
            y: this.y.baseVal[0].value,
            fig: this.id,
            event: "click",
            tim: Date.now(),
            tdiff: (Date.now() - cc[cc.length - 1].tim) / 1000,
            hit: null
          }
        ...
        Draggable.create(".source", {
          bounds:
            svg_navn == "fotball"
              ? { minX: -1850, maxX: -1100, minY: -500, maxY: 150 }
              : "#" + imid,
          dragResistance: -0.1,
          ...
          onDrag: function(e) {
            ...
            if (
              cc.length == 1 ||
              this.x - cc[cc.length - 1].x > terskel ||
              this.x - cc[cc.length - 1].x < -terskel ||
              this.y - cc[cc.length - 1].y > terskel ||
              this.y - cc[cc.length - 1].y < -terskel
            ) {
              cc[cc.length] = {
                x: this.x,
          ...
          onDragEnd: function(e) {
            ...
            console.log(
              this.target.id,
              "ny x-posisjon" + this.x,
              " ny y-posisjon" + this.y,
              " x og y: ",
              cc[cc.length - 1]
            )
            ...
            while (--i > -1) {
              if (this.hitTest(targ1.members[i].node)) {
                ...
                var disappear =
                  this.target.classList[2] == "disappear" ? true : false
                if (disappear) {
                ...
                //var readtext = (sel_que.length!=0)? sel_que[0].node.textContent: "";
                var readtext =
                  sel_que.length != 0 ? sel_que[0].node.textContent : ""
